...
maproducto_periodo_act AS ( 
	SELECT  
			 ...
			 MAX("PESO") AS "PESO" -- este debe ser el peso del proceso de separación peso y uxe
...
ma_producto_periodo_act_row_number AS ( -- pendiente ordenar tambien por mes, validar porque ser ordena por COD_TIPO_CARNE
